...
5. **Package up your work into a zine!** Now for the fun part. You will take your work from steps 1-4 and turn it into a [zine](https://www.mcnutt.in/zine-potential/assets/web-zine.pdf). Zines have a long, and storied history for communicating specialized, unconventional, or disruptive subject matter in a DIY fashion. They can be remarkably effective for proliferating ideas that are otherwise on the periphery of more mainstream or authoritative sources. To package up your work, please follow these steps:

   1. Please use this [Canva template](https://www.canva.com/design/DAHA8GR6NEc/E-1eOdlWVckUXB60FVTrTg/edit?utm_content=DAHA8GR6NEc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton). You are free to adopt any design you wish (in terms of layout, graphics, and typesetting). If you wish to deviate from the zine template above, please get permission from the course staff first.

   2. We will handle printing logistics for your zine after the deadline has passed. You will then fold your zines for our peer share/review the following week (Week 11).
...
- Checking out this [zine that your TA's worked on](https://zxnnic.github.io/data/pdf/ai-companion-zine.pdf) to help dessiminate their research. (Ask one of us during your next design checkpoint if you'd like a physical copy!)
