...
![Lab 6 - Preview](assets/cs171-lab6-preview.gif?raw=true "Lab 7 - Preview")


- **Activity 1: Learning about D3 shapes**
   - Load data and create a pie chart using D3 shapes and arcs.

- **Activity 2: Dip your toes in GeoJSON**
   - Create a choropleth (world) map and implement a feature that updates the colors of the countries as well as a feature that allows users to
  rotate the globe (with tooltips!)
